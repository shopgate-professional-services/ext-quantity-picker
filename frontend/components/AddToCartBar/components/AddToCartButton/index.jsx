...
import { I18n, TickIcon, IndicatorCircle } from '@shopgate/engage/components';
...
class AddToCartButton extends Component {
  ...
  render() {
    ...
    let cartTextStyle = `${styles.icon} ${styles.buttonText(this.props.fontSize)}`;
    ...
    if (this.props.isDisabled && !this.props.isLoading) {
      ...
      cartTextStyle += ` ${styles.springToTop}`;
      ...
      cartTextStyle += ` ${styles.springFromTop}`;
      /**
       * After the keyframe animation is done the transform values are reset
       * We add the inline style to make sure the icons stay where they are even after the animation
       */
